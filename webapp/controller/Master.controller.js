sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.untitledPrototype.controller.Master", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App5c7ce06bab34a302f4a45d24";
		...
		_onSearchFieldSearch: function(oEvent) {
			var sControlId = "sap_m_Page_0-content-sap_m_StandardList-1551689479622";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					if (!isNaN(iQuery)) {
						aFilters.push(new sap.ui.model.Filter("Sum", sap.ui.model.FilterOperator.EQ, sQuery));
					}
		...
		_onObjectListItemPress: function(oEvent) {
			...
			// var oItem=oEvent.getParameter("listItem") || Event.getSource();
			// alert(oItem.getBindingContext().getProperty("ID"));
		},
		_showDetail: function(oItem)
		{
			...
			this.getOwnerComponent().getRouter().navTo("Detail", {
				objectID: oItem.getBindingContext().getProperty("ID")}, bReplace);
		},
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-content-sap_m_StandardList-1551689479622",
				"groups": ["items"]
			}];
